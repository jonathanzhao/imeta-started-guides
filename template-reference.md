...
- 变量表达式(variable)<br/>
![name](https://raw.githubusercontent.com/jonathanzhao/imeta-started-guides/master/images/tpl/e/variable.png "name")
- 条件表达式(condition)<br/>
...
- 独立语句(statement)<br/>
![name](https://raw.githubusercontent.com/jonathanzhao/imeta-started-guides/master/images/tpl/e/statement.png "name")
- 条件分支语句(subbranch)<br/>
...
- 自定义函数语句(func)<br/>
![name](https://raw.githubusercontent.com/jonathanzhao/imeta-started-guides/master/images/tpl/e/func.png "name")
- 循环语句(loop)<br/>
![name](https://raw.githubusercontent.com/jonathanzhao/imeta-started-guides/master/images/tpl/e/loop.png "name")
- 作用域语句(with)<br/>
![name](https://raw.githubusercontent.com/jonathanzhao/imeta-started-guides/master/images/tpl/e/with.png "name")
